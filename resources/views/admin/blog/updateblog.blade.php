    ...
    <div class="container mt-5">
        <div class="page-inner">
            ...
            <div class="form-container bg-white p-4 shadow rounded-lg">
                ...
                @endif
                <form action="{{ route('admin.blog.managerblog.update', ['id' => $blog->id]) }}" id="form-create"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="title" id="validationCustom01"
                            placeholder="Nhập tiêu đề bài viết" required value="{{ $blog->title }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="description" id="validationCustom02" cols="50" rows="5"
                            placeholder="Nhập mô tả bài viết" required>{{ $blog->description }}</textarea>
                        <div class="invalid-feedback">
                            Vui lòng nhập mô tả.
                        </div>
                    </div>
                    <div class="col-md-6 text-center">
                        <img id="previewImage" src="{{ $blog->image ? asset('assets/image/blogs/' . $blog->image) : '#' }}"
                            alt="Preview Image"
                            style="max-width: 250px; height: auto; border: 1px solid #ccc; padding: 5px; border-radius: 5px;" />

                    </div>
                    <div class="col-12">
                        <button class="btn btn-primary py-2" type="submit">Cập nhật bài viết</button>
                    </div>
                </form>
            </div>
        </div>
