    ...
    <div class="container mt-5">
        <div class="page-inner">
            ...
            <div class="form-container bg-white p-4 shadow rounded-lg">
                <h2 class="text-center mb-4">Tạo Danh Mục Sản Phẩm Mới</h2>
                @if ($errors->any())
                ...
                @endif
                <form action="{{ route('admin.category.managercategory.store') }}" id="form-create" method="POST"
                    ...
                    <div class="col-12">
                        <button class="btn btn-primary py-2" type="submit">Tạo danh mục</button>
                    </div>
                </form>
            </div>
        </div>
