...
<div class="container">
    ...
    <div class="row" style="width: 100%;">
        <div class="col-md-12 mb-3">
            <form action="{{ route('products.search') }}" method="GET" class="form-inline d-flex justify-content-end">
                <input type="text" name="query" class="form-control form-control-sm mr-2"
                    placeholder="Tìm kiếm sản phẩm..." style="width: 300px;">
        ...
        <div class="col-md-3">
            ...
            <form action="{{ route('products.filterProduct') }}" method="GET" class="form-inline">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="price_ranges[]" value="0-1000000"
                        id="price_0_1000000" {{ in_array('0-1000000', request('price_ranges', [])) ? 'checked' : '' }}>
                    <label class="form-check-label" for="price_0_1000000">Dưới 1 triệu VND</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="price_ranges[]" value="1000000-5000000"
                        id="price_1000000_5000000"
                        {{ in_array('1000000-5000000', request('price_ranges', [])) ? 'checked' : '' }}>
                    <label class="form-check-label" for="price_1000000_5000000">1 triệu - 5 triệu VND</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="price_ranges[]" value="5000000-10000000"
                        id="price_5000000_10000000"
                        {{ in_array('5000000-10000000', request('price_ranges', [])) ? 'checked' : '' }}>
                    <label class="form-check-label" for="price_5000000_10000000">5 triệu - 10 triệu VND</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="price_ranges[]" value="10000000-20000000"
                        id="price_10000000_20000000"
                        {{ in_array('10000000-20000000', request('price_ranges', [])) ? 'checked' : '' }}>
                    <label class="form-check-label" for="price_10000000_20000000">10 triệu - 20 triệu VND</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="price_ranges[]" value="20000000-1000000000"
                        id="price_20000000"
                        {{ in_array('20000000-1000000000', request('price_ranges', [])) ? 'checked' : '' }}>
                    <label class="form-check-label" for="price_20000000">Trên 20 triệu VND</label>
                </div>
                    ...
                    <div class="card w-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                ...
                                <button class="btn btn-secondary btn-block">XEM THÊM</button>
                            </div>
                        </div>
                    </div>
                </div>
